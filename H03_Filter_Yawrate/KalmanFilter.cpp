...
void KalmanFilter::filter(){
    ...
    //std::cout << "P012:" << statesCovariance(0, 0) << std::endl;
    //std::cout << "A12:" << transitionMatrix(0, 0)  << std::endl;
    //std::cout << "A12:" << transitionMatrix.transpose()(0, 0) << std::endl;
    //std::cout << "Q12:" << predictNoise(0, 0)  << std::endl;
    // 1.2 预测方差更新P(k)=A*P(k-1)*At+Q(k)
    Eigen::MatrixXd P_ = transitionMatrix*statesCovariance*transitionMatrix.transpose() + predictNoise;
    //std::cout <<"P12:"<< P_(0, 0) << std::endl;
    // 2.0 遍历观测量，并融合
    for(size_t i=0; i<observation_num; i++){
        ...
        //std::cout << "Xout res interal:" << states[0] << " " << states[1] << std::endl;
    }
    return;
}
...
//// sub class
//
//float WheelLoadBased::fgetResult()
//{
//    return this->Res_Wheel;
//}
//float YawrateBased::fgetResult()
//{
//    return this->Res_Yawrate;
//}
//float LateralAccBased::fgetResult()
//{
//    return this->Res_Acc;
//}
//float SteeringAngleBased::fgetResult()
//{
//    return this->Res_Steering;
//}
//float FinalMerge::fgetResult()
//{
